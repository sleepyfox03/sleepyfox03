...
class SatvikChandel:
    def __init__(self):
        ...
        self.roles      = ["Full Stack Developer", "Data Science Student",
                           "Coding Facilitator", "DGCA Certified Drone Pilot 🚁"]
        self.stack      = {
            ...
            "database"  : ["MySQL"],
            "others"    : ["REST APIs", "Git", "Micro:bit", "ESP32"]
        }
...
- 🛡️ **Cisco** — Data Analytics Essentials Badge
- 🐍 **Cisco** — Python Essentials Badge
- 🗄️ **MySQL** Skill Certification
...
```
📌 Coding Facilitator & Curriculum Designer @ TalentGum   [Jan 2025 – Sep 2025]
   ⭐ 4.88/5.0 Teacher Rating   |   90%+ Student Retention

📌 Robotics Instructor @ BrightChamps                     [May 2024 – Sep 2024]
   🤖 Taught 50+ students   |   20% boost in retention

📌 Software Associate Intern @ iCube Systems              [Mar 2023 – Jun 2023]
   ⚡ 50% reduction in page load time via Vue.js migration
```
